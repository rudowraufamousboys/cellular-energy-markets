...
#            
#            energyOfferA1toB1l=energyOfferA1l[z]/2
#            energyOfferA1toB2l=energyOfferA1l[z]/2
#            # hier iteration nach unten
#            print('Bedingung 1 erfuellt!')
#            
#        elif LastpriceSupplyC1C2B1df.iloc[0,0] > priceMarketequilibrium and \
#        ExcesssupplyC1C2B1l[z] > 0:
#            
#            energyOfferA1toB1l=energyOfferA1l
#            # hier iteration nach unten
#            print('Bedingung 2 erfuellt!')
#            
#        elif LastpriceSupplyC3C4B2df.iloc[0,0] > priceMarketequilibrium and \
#        ExcesssupplyC3C4B2l[z] > 0:
#            
#            energyOfferA1toB2l=energyOfferA1l
#            # hier iteration nach unten
#            print('Bedingung 3 erfuellt!')
#            
#        else:
#            print('keine Bedingung erfuellt!')
