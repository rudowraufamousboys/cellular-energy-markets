# -*- coding: utf-8 -*-
"""
Created on Wed Feb 27 13:46:39 2019
    ...
    ###############################energy cut##################################
            ...
            for Z in range (1,len(x_values)):
                ...
                if x_values[-Z]> energyMarketequilibrium:
                    ...
                    print(offer_names[-Z]+' wird abgeregelt')
                
                    if (x_values[-Z]-x_values[-Z-1])<(x_values[-Z]-energyMarketequilibrium):
                        print(x_values[-Z]-x_values[-Z-1])
                    else:
                        print(x_values[-Z]-energyMarketequilibrium)
            ...
            if x_values[0]>energyMarketequilibrium:
                ...
                print(offer_names[0]+' wird abgeregelt')  
                    
                print(x_values[0]-energyMarketequilibrium)
            
            print(x_values[len(x_values)-1]-energyMarketequilibrium)
