...
for z in range(SupplyB1B2A1df.index.size-1):
        ...
        #Flexdemand
        Fxi=[x_load[0],x_load[0]+50,x_load[0]+50]
        Fyi=[20,20,0]
        ...
        for Z in range (1,len(x_supplyacc)):
                ...
                if Fxi[1]>x_supplyacc[-Z] and x_supplyacc[-Z]==x_supplyacc[-Z+1] and Fyi[1]>=y_supplyacc[-Z+1]:
                    
                    y_me=y_supplyacc[-Z]
                    x_me=x_load[0]
                    x_offer=x_supplyacc[-Z+1]-x_load[0]
                    
                    #Fxi=[x_load[0],x_load[0]+50-0.5*z,x_load[0]+50-0.5*z]
                ...
                if x_load[0]> x_supplyacc[-Z]:
                    ...
                    y_me=y_supplyacc[-Z+1]
                    x_me=Fxi[1]
                    x_offer=x_supplyacc[-Z+1]-Fxi[1]
